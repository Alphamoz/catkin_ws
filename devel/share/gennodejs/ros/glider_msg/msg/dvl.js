...
class dvl {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.int32(obj.dataGood, buffer, bufferOffset, 4);
    ...
    bufferOffset = _serializer.int32(obj.velocityInstFlag, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.int32(obj.velocityEarthFlag, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.int32(obj.waterVelocityInstFlag, buffer, bufferOffset);
    ...
    bufferOffset = _serializer.int32(obj.waterVelocityEarthFlag, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.dataGood = _arrayDeserializer.int32(buffer, bufferOffset, 4)
    ...
    data.velocityInstFlag = _deserializer.int32(buffer, bufferOffset);
    ...
    data.velocityEarthFlag = _deserializer.int32(buffer, bufferOffset);
    ...
    data.waterVelocityInstFlag = _deserializer.int32(buffer, bufferOffset);
    ...
    data.waterVelocityEarthFlag = _deserializer.int32(buffer, bufferOffset);
  ...
  static datatype() {
    ...
    return 'glider_msg/dvl';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '27a25dcadf0cd6f4f4c2690f3adac589';
  }
