...
(cl:defmethod cl:initialize-instance :after ((m <dvl>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'dvl)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name glider_msg-msg:<dvl> is deprecated: use glider_msg-msg:dvl instead.")))
...
(cl:defmethod errCode-val ((m <dvl>))
...
(cl:defmethod dataGood-val ((m <dvl>))
...
(cl:defmethod altitudeBeam-val ((m <dvl>))
...
(cl:defmethod bottomVelocityBeam-val ((m <dvl>))
...
(cl:defmethod waterVelocityBeam-val ((m <dvl>))
...
(cl:defmethod waterVelocityCredit-val ((m <dvl>))
...
(cl:defmethod velocityInst-val ((m <dvl>))
...
(cl:defmethod velocityInstFlag-val ((m <dvl>))
...
(cl:defmethod velocityEarth-val ((m <dvl>))
...
(cl:defmethod velocityEarthFlag-val ((m <dvl>))
...
(cl:defmethod waterVelocityInst-val ((m <dvl>))
...
(cl:defmethod waterVelocityInstFlag-val ((m <dvl>))
...
(cl:defmethod waterVelocityEarth-val ((m <dvl>))
...
(cl:defmethod waterVelocityEarthFlag-val ((m <dvl>))
...
(cl:defmethod heading-val ((m <dvl>))
...
(cl:defmethod soundSpeed-val ((m <dvl>))
...
(cl:defmethod rawData-val ((m <dvl>))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <dvl>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'velocityInstFlag)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'velocityEarthFlag)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'waterVelocityInstFlag)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'waterVelocityEarthFlag)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <dvl>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'velocityInst)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'velocityInstFlag) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  ...
  (cl:let ((vals (cl:slot-value msg 'velocityEarth)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'velocityEarthFlag) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  ...
  (cl:let ((vals (cl:slot-value msg 'waterVelocityInst)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'waterVelocityInstFlag) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  ...
  (cl:let ((vals (cl:slot-value msg 'waterVelocityEarth)))
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'waterVelocityEarthFlag) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<dvl>)))
  ...
  "27a25dcadf0cd6f4f4c2690f3adac589")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'dvl)))
  "Returns md5sum for a message object of type 'dvl"
  "27a25dcadf0cd6f4f4c2690f3adac589")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<dvl>)))
  ...
  (cl:format cl:nil "Header header~%string errCode~%int32[4] dataGood~%float32[4] altitudeBeam~%float32[4] bottomVelocityBeam~%float32[4] waterVelocityBeam~%float32[4] waterVelocityCredit~%float32[3] velocityInst~%int32 velocityInstFlag~%float32[3] velocityEarth~%int32 velocityEarthFlag~%float32[3] waterVelocityInst~%int32 waterVelocityInstFlag~%float32[3] waterVelocityEarth~%int32 waterVelocityEarthFlag~%float32 roll~%float32 pitch~%float32 heading~%float32 altitude~%float32 temperature~%float32 pressure~%float32 salinity~%float32 soundSpeed~%string rawData~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'dvl)))
  "Returns full string definition for message of type 'dvl"
  (cl:format cl:nil "Header header~%string errCode~%int32[4] dataGood~%float32[4] altitudeBeam~%float32[4] bottomVelocityBeam~%float32[4] waterVelocityBeam~%float32[4] waterVelocityCredit~%float32[3] velocityInst~%int32 velocityInstFlag~%float32[3] velocityEarth~%int32 velocityEarthFlag~%float32[3] waterVelocityInst~%int32 waterVelocityInstFlag~%float32[3] waterVelocityEarth~%int32 waterVelocityEarthFlag~%float32 roll~%float32 pitch~%float32 heading~%float32 altitude~%float32 temperature~%float32 pressure~%float32 salinity~%float32 soundSpeed~%string rawData~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <dvl>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'dataGood) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
