// Generated by gencpp from file glider_msg/dvl.msg
// DO NOT EDIT!


#ifndef GLIDER_MSG_MESSAGE_DVL_H
#define GLIDER_MSG_MESSAGE_DVL_H
...
struct dvl_
{
  ...
  _errCode_type errCode;
   ...
   typedef boost::array<int32_t, 4>  _dataGood_type;
  ...
  _waterVelocityInst_type waterVelocityInst;
   ...
   typedef int32_t _waterVelocityInstFlag_type;
  ...
  _waterVelocityEarth_type waterVelocityEarth;
   ...
   typedef int32_t _waterVelocityEarthFlag_type;
  ...
  typedef boost::shared_ptr< ::glider_msg::dvl_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::glider_msg::dvl_<ContainerAllocator> const> ConstPtr;

}; // struct dvl_

typedef ::glider_msg::dvl_<std::allocator<void> > dvl;

typedef boost::shared_ptr< ::glider_msg::dvl > dvlPtr;
typedef boost::shared_ptr< ::glider_msg::dvl const> dvlConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::glider_msg::dvl_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::glider_msg::dvl_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::glider_msg::dvl_<ContainerAllocator1> & lhs, const ::glider_msg::dvl_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::glider_msg::dvl_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::glider_msg::dvl_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::glider_msg::dvl_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::glider_msg::dvl_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::glider_msg::dvl_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::glider_msg::dvl_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::glider_msg::dvl_<ContainerAllocator> >
{
  ...
  static const char* value(const ::glider_msg::dvl_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x27a25dcadf0cd6f4ULL;
  static const uint64_t static_value2 = 0xf4c2690f3adac589ULL;
};

template<class ContainerAllocator>
struct DataType< ::glider_msg::dvl_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::glider_msg::dvl_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::glider_msg::dvl_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::glider_msg::dvl_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::glider_msg::dvl_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
    ...
    {
      s << indent << "  dataGood[" << i << "]: ";
      Printer<int32_t>::stream(s, indent + "  ", v.dataGood[i]);
    }
    ...
    Printer<int32_t>::stream(s, indent + "  ", v.velocityInstFlag);
    ...
    Printer<int32_t>::stream(s, indent + "  ", v.velocityEarthFlag);
    ...
    Printer<int32_t>::stream(s, indent + "  ", v.waterVelocityInstFlag);
    ...
    Printer<int32_t>::stream(s, indent + "  ", v.waterVelocityEarthFlag);
    s << indent << "roll: ";
...
#endif // GLIDER_MSG_MESSAGE_DVL_H
